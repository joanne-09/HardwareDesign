...
HD_PWD='C:/Users/User/Documents/programming/verilogLearning/HardwareDesign/EasonsLab3adv/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_advanced.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab3_advanced.tcl
