...
HD_PWD='C:/Users/User/Documents/programming/verilogLearning/HardwareDesign/EasonsLab3adv/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_advanced.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab3_advanced.tcl -notrace
